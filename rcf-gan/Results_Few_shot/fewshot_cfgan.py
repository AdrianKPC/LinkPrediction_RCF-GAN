...
from fewshot_utility import prepare_dir, get_input_white_noise, get_graph_target, record_as_img, avg_record, \
...
#        print('Validation now ------------')
        ...
        np.savetxt('fewshot_cora.txt', np.column_stack((training_roc, training_ap, test_roc, test_ap)))
