...
from fewshot_utility_cora import prepare_dir, get_input_white_noise, get_graph_target, record_as_img, avg_record, \
...
#        print('Validation now ------------')
        ...
        np.savetxt('fewshot_cora_75percent_.txt', np.column_stack((training_roc, training_ap, test_roc, test_ap)))
