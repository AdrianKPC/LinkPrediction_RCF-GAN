...
from fs1_cora_more_utility import prepare_dir, get_input_white_noise, get_graph_target, record_as_img, avg_record, \
...
#        print('Validation now ------------')
        ...
        np.savetxt('fs2more_graph_cora_10percent_50_.txt', np.column_stack((training_roc, training_ap, test_roc, test_ap)))
