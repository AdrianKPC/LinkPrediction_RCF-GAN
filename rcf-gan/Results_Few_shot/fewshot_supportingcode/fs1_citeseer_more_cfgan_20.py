...
from fs1_citeseer_more_utility_20 import prepare_dir, get_input_white_noise, get_graph_target, record_as_img, avg_record, \
...
#        print('Validation now ------------')
        ...
        np.savetxt('fs2more_graph_citeseer_20percent_50_.txt', np.column_stack((training_roc, training_ap, test_roc, test_ap)))
