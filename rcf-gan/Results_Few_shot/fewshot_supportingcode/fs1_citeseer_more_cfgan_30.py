...
from fs1_citeseer_more_utility_30 import prepare_dir, get_input_white_noise, get_graph_target, record_as_img, avg_record, \
...
#        print('Validation now ------------')
        ...
        np.savetxt('fs2more_graph_citeseer_30percent_50_.txt', np.column_stack((training_roc, training_ap, test_roc, test_ap)))
