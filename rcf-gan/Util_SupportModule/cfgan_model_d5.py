...
from network_module_d5 import SampleNet, AdvNet, InnerProductDecoder
...
#        print('Validation now ------------')
        ...
        np.savetxt('accuracies_citeseer_basic_netdim128_epoch50_depth5.txt', np.column_stack((training_roc, training_ap, test_roc, test_ap)))
