...
from network_module_d7 import SampleNet, AdvNet, InnerProductDecoder
...
#        print('Validation now ------------')
        ...
        np.savetxt('accuracies_pubmed_basic_netdim128_epoch50_depth7.txt', np.column_stack((training_roc, training_ap, test_roc, test_ap)))
