...
from cfgan_model_a7b3_lr1e5 import Model
#import time
#import os
#import matplotlib.pyplot as plt
#import numpy as np
...
target_source = 'cora'  # cora citeseer pubmed nell.0.1
...
generator_training_param = {'input_noise_dim': feature_dim,
                            'input_noise_var': 0.3, 'net_type': 'gnn', 'lr': 1e-5, 'inner_ite_per_batch': 1,
...
adversarial_training_param = {'input_t_dim': feature_dim, 'input_t_batchsize': target_batch_size,
                              'input_t_var': 1, 'net_type': 'gnn', 'lr': 1e-5, 'inner_ite_per_batch': 1,
