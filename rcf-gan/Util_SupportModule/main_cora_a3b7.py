...
from cfgan_model_128 import Model
#import time
#import os
#import matplotlib.pyplot as plt
#import numpy as np
...
generator_training_param = {'input_noise_dim': feature_dim,
                            'input_noise_var': 0.3, 'net_type': 'gnn', 'lr': 5e-4, 'inner_ite_per_batch': 1,
...
adversarial_training_param = {'input_t_dim': feature_dim, 'input_t_batchsize': target_batch_size,
                              'input_t_var': 1, 'net_type': 'gnn', 'lr': 5e-4, 'inner_ite_per_batch': 1,
