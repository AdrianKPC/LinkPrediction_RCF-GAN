...
ax1.plot(epochs, train_roc, label='RCF-GAN Testing (AUC)', color='#1f77b4')
ax2.plot(epochs, train_ap, label='RCF-GAN Testing (AP)', color='#ff7f0e')
ax1.plot(epochs, test_roc, '--', label='RCF-GAN Training (AUC)', color='#1f77b4')
ax2.plot(epochs, test_ap, '--', label='RCF-GAN Training (AP)', color='#ff7f0e')
