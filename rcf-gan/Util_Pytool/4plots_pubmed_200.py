...
array1 = np.loadtxt('accuracies_pubmed_basic_netdim128_epoch200.txt')
array2 = np.loadtxt('vgae_pubmed_200_corr.txt')
array3 = np.loadtxt('gae_accuracies_pubmed_200epoch_.txt')
...
legend = ax1.legend(lines, labels, loc='center right', fontsize=12, ncol=2)
