...
array1 = np.loadtxt('accuracies_pubmed_basic_netdim128_epoch50.txt')
array2 = np.loadtxt('vgae_pubmed_50epoch_newplot.txt')
array3 = np.loadtxt('gae_accuracies_pubmed_50epoch_1.txt')
...
ax1.plot(epochs, array1[:, 0], label='RCF-GAN (AUC)', color='blue', linewidth=2)
ax2.plot(epochs, array1[:, 1], '--', label='RCF-GAN (AP)', color='blue', linewidth=2)

# VGAE (AUC) and VGAE (AP)
ax1.plot(epochs, array2[:, 2], label='VGAE (AUC)', color='orange', linewidth=2)
ax2.plot(epochs, array2[:, 3], '--', label='VGAE (AP)', color='orange', linewidth=2)
